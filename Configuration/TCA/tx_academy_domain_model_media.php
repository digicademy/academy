...
return array(
    ...
    'types' => array(
        '1' => array(
            ...
            --div--;LLL:EXT:academy/Resources/Private/Language/locallang_db.xml:tx_academy_domain_model_media.div3,
                relations,
            --div--;LLL:EXT:academy/Resources/Private/Language/locallang_db.xml:tx_academy_domain_model_media.div4,
                statements,
    ...
    'columns' => array(
        ...
        'statements' => array(
            'exclude' => 1,
            'label' => 'LLL:EXT:academy/Resources/Private/Language/locallang_db.xml:tx_academy_domain_model_media.statements',
            'config' => array(
                'type' => 'group',
                'internal_type' => 'db',
                ...
                'MM_match_fields' => array(
                    ...
                    'ident' => 'tx_academy_domain_model_media',
