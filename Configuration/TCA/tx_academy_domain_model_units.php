...
return array(
    'ctrl' => array(
        ...
        'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('academy') . 'Resources/Public/Icons/tx_academy_domain_model_units.svg'
    ),
    'interface' => array(
        'showRecordFieldList' => '
            sys_language_uid, 
    ...
    'types' => array(
        '1' => array(
            ...
            --div--;LLL:EXT:academy/Resources/Private/Language/locallang_db.xml:tx_academy_domain_model_units.div3,
                relations,
            --div--;LLL:EXT:academy/Resources/Private/Language/locallang_db.xml:tx_academy_domain_model_units.div4,
                statements,
    ...
    'columns' => array(
        ...
        'statements' => array(
            'exclude' => 1,
            'label' => 'LLL:EXT:academy/Resources/Private/Language/locallang_db.xml:tx_academy_domain_model_units.statements',
            'config' => array(
                'type' => 'group',
                'internal_type' => 'db',
                ...
                'MM_match_fields' => array(
                    ...
                    'ident' => 'tx_academy_domain_model_units',
